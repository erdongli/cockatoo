...
func (c *gatewayClient) Connect(ctx context.Context, opts ...grpc.CallOption) (Gateway_ConnectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Gateway_ServiceDesc.Streams[0], "/cockatoo.api.Gateway/Connect", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *gatewayConnectClient) Send(m *Packet) error {
	return x.ClientStream.SendMsg(m)
}

func (x *gatewayConnectClient) Recv() (*Packet, error) {
	m := new(Packet)
...
func (x *gatewayConnectServer) Send(m *Packet) error {
	return x.ServerStream.SendMsg(m)
}

func (x *gatewayConnectServer) Recv() (*Packet, error) {
	m := new(Packet)
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cockatoo.api.Gateway",
